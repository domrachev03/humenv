...
# Source: https://github.com/ZhengyiLuo/SMPLSim/blob/master/smpl_sim/utils/np_transform_utils.py
...
def quat_rotate(q, v):
    ...
    c = q_vec * (q_vec.reshape(shape[0], 1, 3) @ v.reshape(shape[0], 3, 1)).squeeze(-1) * 2.0
    return a + b + c
